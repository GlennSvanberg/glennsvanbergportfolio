...
export const projects: Array<Project> = [
  ...
  },
  {
    ...
    imageUrlMobile: "/braian-mobile.png",
    colSpan: 2,
    rowSpan: 1,
  },
  {
  ...
  },
  {
    ...
    imageUrlMobile: "/allergy-mobile.png",
    colSpan: 1,
    rowSpan: 1,
  },
  {
  ...
  },
  {
    ...
    tags: ["E-handel", "Realtid"],
    description:
      "Digital tvilling för second hand-butiker: samma flöde för inlämning, lager och kundbutik, med AI-stöd för titel och pris och realtid så unika plagg inte säljs dubbelt.",
    url: "https://selio.se",
    imageUrlDesktop: "/selio-desktop.png",
    imageUrlMobile: "/selio-mobile.png",
    colSpan: 1,
    rowSpan: 1,
  },
  {
  ...
  },
  {
    ...
    name: "Family Home",
    tags: ["Personligt"],
    description: "Inköpslista för hemmet – en enkel sida för familjens gemensamma handel och pantry.",
    url: "https://home.glennsvanberg.se",
    imageUrlDesktop: "/home-desktop.png",
    imageUrlMobile: "/home-mobile.png",
    colSpan: 1,
    rowSpan: 1,
  },
  {
    ...
    tags: ["AI", "Verktyg"],
    description:
      "Ta bort bakgrund med AI i webbläsaren via WebGPU (BiRefNet lokalt) – inga uppladdningar, ingen vattenstämpel; bilden lämnar aldrig enheten.",
    url: "https://removebg.glennsvanberg.se",
    imageUrlDesktop: "/removebg-desktop.png",
    imageUrlMobile: "/removebg-mobile.png",
    colSpan: 1,
    rowSpan: 1,
  },
  {
    id: "music",
    name: "Music",
    tags: ["Personligt", "Realtid"],
    description:
      "Ett experiment: kameran följer händerna och du styr musiken som en dirigent genom att vinka med fingrarna. Mycket färg, hypnotiska rörelser i gränssnittet – mest lek och utforskning.",
    url: "https://music.glennsvanberg.se",
    imageUrlDesktop: "/music-desktop.png",
    imageUrlMobile: "/music-mobile.png",
    colSpan: 1,
    rowSpan: 1,
  },
];
